...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.zombie-turret-farm.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Zombie Turret Farm Wiki",
    description: "Read the Terms of Service for Zombie Turret Farm Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "Zombie Turret Farm Wiki",
      title: "Terms of Service - Zombie Turret Farm Wiki",
      description: "Terms and conditions for using Zombie Turret Farm Wiki.",
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: "Zombie Turret Farm Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Zombie Turret Farm Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Zombie Turret Farm Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Zombie Turret Farm Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Zombie Turret Farm Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Zombie Turret Farm". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and beginner tutorials</li>
              <li>Codes and free rewards tracking</li>
              <li>Turret stats and tier list rankings</li>
              <li>Base layout and turret wall setups</li>
              <li>AFK and offline farming guides</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Zombie Turret Farm Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or the official developers of Zombie Turret Farm. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Zombie Turret Farm Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or the developers of Zombie Turret Farm. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, ZOMBIE TURRET FARM WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Zombie Turret Farm Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@zombie-turret-farm.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@zombie-turret-farm.wiki</a>
            </p>
            <p>
