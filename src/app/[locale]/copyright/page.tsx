...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Zombie Turret Farm Wiki',
    description: 'Copyright and intellectual property information for Zombie Turret Farm Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Zombie Turret Farm Wiki',
      description: 'Copyright and intellectual property information for Zombie Turret Farm Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Zombie Turret Farm Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Zombie Turret Farm Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Zombie Turret Farm Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>BrainRot Zombies Inc</strong> - Creators of the Zombie Turret Farm game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Zombie Turret Farm</strong> - Trademark of BrainRot Zombies Inc</li>
              <li><strong>Zombie Turret Farm Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Zombie Turret Farm Wiki.
            </p>
            ...
            <p>
              ...
              Zombie Turret Farm Wiki<br />
              Email: <a href="mailto:dmca@zombie-turret-farm.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@zombie-turret-farm.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Zombie Turret Farm Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Zombie Turret Farm Wiki (zombie-turret-farm.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@zombie-turret-farm.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@zombie-turret-farm.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@zombie-turret-farm.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@zombie-turret-farm.wiki</a>
            </p>
            <p>
